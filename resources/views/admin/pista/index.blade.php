<x-administrador>
 ...
 --}}
            ...
            <tbody>
                @foreach ($pistas as $pista)
                    <tr>
                        <td class="py-2 px-4 text-xl border-b-2 border-gray-500 text-center">{{ $pista->ubicacion->nombre }}</td>
                        <td class="py-2 px-4 text-xl border-b-2 border-gray-500 text-center">{{ $pista->superficie->tipo }}</td>
                        <td class="py-2 px-4 text-xl border-b-2 border-gray-500 text-center">{{ $pista->deporte->nombre }}</td>
 ...
 --}}                   <td class="py-2 px-4 text-xl border-b-2 border-gray-500 text-center">{{ $pista->precio_con_luz ?: 'N/A' }}</td>
                        <td class="py-2 px-4 text-xl border-b-2 border-gray-500 text-center">{{ $pista->precio_sin_luz }}</td>
