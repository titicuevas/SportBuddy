     ...
     @endif
        ...
        <form action="{{ route('admin.ubicacion.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nombre" id="nombre" class="w-full border rounded-md p-2 border-opacity-50"
                    required>
            </div>

            <div class="mb-4">
                <label for="direccion" class="block text-sm font-semibold mb-2 text-gray-600">Dirección</label>
                <input type="text" name="direccion" id="direccion" class="w-full border rounded-md p-2 border-opacity-50"
                    required>
            </div>

            <div class="mb-4">
                <label for="enlace_maps" class="block text-sm font-semibold mb-2 text-gray-600">Enlace de Google
                    Maps</label>
